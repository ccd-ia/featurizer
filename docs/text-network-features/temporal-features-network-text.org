...
- =[safe ●●○]= *Near-duplicate / shared-content edges* — MinHash / LSH; the
  copy-paste signature of coordination.
...
- Status as of 0.9.0: Path 1's core reductions (sentiment, NER counts,
  readability, language id), the multi-metric centralities, Louvain
  community, and the native 1-hop neighbour aggregation are shipped (see the
  =shipped 0.9.0= markers above). Remaining GAPs: peer churn, Moran's I, SBM
  entropy / MDL surprise, community persistence, global temporal dynamics;
  trajectory / change-point / text-induced edges are the 0.9.1 line.
