...
TRANSFORMATION_DOCS: Dict[str, Dict[str, Any]] = {
    ...
    "num_words": {
        ...
        "input_types": ["text"],
        "output_type": "numeric",
        "sql_example": "(SELECT count(*) FROM regexp_split_to_table(text, '\\s+') t(w) WHERE w <> '')",
        "category": "text",
    },
    "num_sentences": {
        "description": "Sentence-terminator count (. ! ?)",
        "input_types": ["text"],
        "output_type": "numeric",
        "sql_example": "length(text) - length(regexp_replace(text, '[.!?]', '', 'g'))",
        "category": "text",
    },
    "avg_word_length": {
        ...
        "input_types": ["text"],
        "output_type": "numeric",
        "sql_example": "non_space_chars::numeric / nullif(num_words, 0)",
        "category": "text",
    },
    "caps_ratio": {
        "description": "Uppercase letters / all letters",
        "input_types": ["text"],
        "output_type": "numeric",
        "sql_example": "upper_letters::numeric / nullif(all_letters, 0)",
        "category": "text",
    },
    "digit_ratio": {
        "description": "Digits / all characters",
        "input_types": ["text"],
        "output_type": "numeric",
        "sql_example": "digit_chars::numeric / nullif(length(text), 0)",
        "category": "text",
    },
    "punct_ratio": {
        "description": "Punctuation / all characters",
        "input_types": ["text"],
        "output_type": "numeric",
        "sql_example": "punct_chars::numeric / nullif(length(text), 0)",
        "category": "text",
    },
    "exclamation_count": {
        ...
        "input_types": ["text"],
        "output_type": "numeric",
        "sql_example": "length(text) - length(replace(text, '!', ''))",
        "category": "text",
    },
    "question_count": {
        "description": "Count of '?' characters",
    ...
    "unique_word_ratio": {
        "description": "Distinct words / total words (type-token ratio)",
        "input_types": ["text"],
        "output_type": "numeric",
        "sql_example": "distinct_words::numeric / nullif(num_words, 0)",
        "category": "text",
    },
    # Date transformers
    "day": {
