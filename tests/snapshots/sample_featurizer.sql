        ...
        count( visit_id ) as "COUNT(visits.visit_id)" ,count( visit_id )  filter (where  daterange((aod.as_of_date - interval 'P1D')::date, aod.as_of_date::date, '[]')  @>  visited_at::date)  as "COUNT(visits.visit_id|interval=P1D)" ,count( visited_at ) as "COUNT(visits.visited_at)" ,count( visited_at )  filter (where  daterange((aod.as_of_date - interval 'P1D')::date, aod.as_of_date::date, '[]')  @>  visited_at::date)  as "COUNT(visits.visited_at|interval=P1D)" ,avg( "ABS(visits.duration_minutes)" ) as "MEAN(visits.ABS(visits.duration_minutes))" ,avg( "ABS(visits.duration_minutes)" )  filter (where  daterange((aod.as_of_date - interval 'P1D')::date, aod.as_of_date::date, '[]')  @>  visited_at::date)  as "MEAN(visits.ABS(visits.duration_minutes)|interval=P1D)" ,avg( duration_minutes ) as "MEAN(visits.duration_minutes)" ,avg( duration_minutes )  filter (where  daterange((aod.as_of_date - interval 'P1D')::date, aod.as_of_date::date, '[]')  @>  visited_at::date)  as "MEAN(visits.duration_minutes|interval=P1D)" ,percentile_cont(0.5) within group(order by "ABS(visits.duration_minutes)") as "MEDIAN(visits.ABS(visits.duration_minutes))" ,percentile_cont(0.5) within group(order by "ABS(visits.duration_minutes)")  filter (where daterange((aod.as_of_date - interval 'P1D')::date, aod.as_of_date::date, '[]') @> visited_at::date) as "MEDIAN(visits.ABS(visits.duration_minutes)|interval=P1D)" ,percentile_cont(0.5) within group(order by duration_minutes) as "MEDIAN(visits.duration_minutes)" ,percentile_cont(0.5) within group(order by duration_minutes)  filter (where daterange((aod.as_of_date - interval 'P1D')::date, aod.as_of_date::date, '[]') @> visited_at::date) as "MEDIAN(visits.duration_minutes|interval=P1D)" ,sum( "ABS(visits.duration_minutes)" ) as "SUM(visits.ABS(visits.duration_minutes))" ,sum( "ABS(visits.duration_minutes)" )  filter (where  daterange((aod.as_of_date - interval 'P1D')::date, aod.as_of_date::date, '[]')  @>  visited_at::date)  as "SUM(visits.ABS(visits.duration_minutes)|interval=P1D)" ,sum( duration_minutes ) as "SUM(visits.duration_minutes)" ,sum( duration_minutes )  filter (where  daterange((aod.as_of_date - interval 'P1D')::date, aod.as_of_date::date, '[]')  @>  visited_at::date)  as "SUM(visits.duration_minutes|interval=P1D)" 
        from visits_transform
        where visited_at <= aod.as_of_date
        group by patient_id
        )
        ,
